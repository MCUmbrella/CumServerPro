...
public class CoreModManager {
    ...
    private static String[] rootPlugins = { "net.minecraftforge.fml.relauncher.FMLCorePlugin", "net.minecraftforge.classloading.FMLForgePlugin", "luohuayu.CatServer.CorePlugin" };
