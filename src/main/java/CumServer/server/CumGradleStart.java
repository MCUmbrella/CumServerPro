...
public class CumGradleStart {
    public static void main(String[] args) throws Throwable
    {
        (new CumGradleStart()).launch(args);
    }
    ...
    static final File       SRG_SRG_MCP   = new File(CumGradleStart.class.getClassLoader().getResource("mappings/" + CumServer.getNativeVersion() + "/srg2mcp.srg").getFile());
    ...
    private String[] getArgs()
    {
        ...
        b.append(']');
        CumGradleStart.LOGGER.info("Running with arguments: " + b.toString());
