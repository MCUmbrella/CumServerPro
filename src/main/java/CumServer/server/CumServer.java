...
import CumServer.server.remapper.ReflectionUtils;
...
public class CumServer {
    ...
    public static void loadConfig() {
        configFile = new File("CumServer.yml");
        if (configFile.exists()) {
            config = YamlConfiguration.loadConfiguration(configFile);
        } else {
            config = YamlConfiguration.loadConfiguration(new InputStreamReader(CumServer.class.getClassLoader().getResourceAsStream("configurations/CumServer.yml")));
            try {
    ...
    public static void reloadFakePlayerPermissions() throws IOException {
        ...
        if (! permissFile.exists()) {
            ...
            InputStreamReader inputStreamReader = new InputStreamReader(CumServer.class.getClassLoader().getResourceAsStream("configurations/fakePlayerPermission.txt"));
