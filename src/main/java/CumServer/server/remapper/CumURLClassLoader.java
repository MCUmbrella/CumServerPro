...
public class CumURLClassLoader extends URLClassLoader
{
...

    {
        ...
        this.remapper = new CumServerRemapper(this.jarMapping);
    }

    public CumURLClassLoader(final URL[] urls, final ClassLoader parent) {
        super(urls, parent);
        this.classes = new HashMap<>();
    }

    public CumURLClassLoader(final URL[] urls) {
        super(urls);
        this.classes = new HashMap<>();
    }

    public CumURLClassLoader(final URL[] urls, final ClassLoader parent, final URLStreamHandlerFactory factory) {
