...
public class ReflectionTransformer {
    ...
    private static final String DESC_RemapMethodHandle = Type.getInternalName(CumHandleLookup.class);
    private static final String DESC_CumURLClassLoader = Type.getInternalName(CumURLClassLoader.class);
    private static final String DESC_CumClassLoader = Type.getInternalName(CumClassLoader.class);
    ...
    public static CumServerRemapper remapper;
    ...
    static {
        ...
        remapSuperClass.put("java/net/URLClassLoader", DESC_CumURLClassLoader);
        remapSuperClass.put("java/lang/ClassLoader", DESC_CumClassLoader);
    }
    ...
    public static void init() {
        ...
        try {
            Class.forName("CumServer.server.remapper.CumHandleLookup");
    ...
    public static byte[] transform(byte[] code) {
        ...
        if (remappedSuperClass != null) {
            if (remappedSuperClass.equals(DESC_CumClassLoader)) remapVirtualMethod.put(node.name + ";defineClass", DESC_CumClassLoader);
